...
const EMOJI_CATEGORIES = {
  ...
  '🍽️ Yeme & İçme': ['🍽️','🍔','🍕','🍝','🍜','🍣','🍰','🍩','🍦','🍫','🍿','☕','🍺','🍷','🥤','🧁','🥗','🌮','🥘','🍱','🍳','🥩','🍗','🍖','🍤','🥐','🍞','🥖','🥨','🥯','🥞','🧀','🍲','🥣','🥛','🍼','🍵','🫖','🍸','🍹','🍻','🥂','🥃','🧃','🧊','🧂','🍎','🍌','🍇','🍓','🍉','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥬','🥒','🌶️','🌽','🥕','🥔'],
  '🛒 Alışveriş': ['🛒','🛍️','🏪','🏬','🎁','📦','🧴','🧹','🧺','🧻','🧽','🧼','🏷️','🎫','🎟️','🚚','🪒','🧳','🧸','🎈','🎀','🧿'],
  '🚗 Ulaşım': ['🚗','🚕','🚙','🚌','🚇','🚆','🚂','✈️','🚀','🛳️','🚲','🛵','🏍️','⛽','🅿️','🚁','🛸','🏎️','🚓','🚑','🚒','🚐','🛻','🚚','🚛','🚜','🛴','🛹','🛼','🚏','🚉','⚓','🗺️','🧭','🛞','🛤️','🚨','🚦','🚥'],
  '🏠 Ev & Yaşam': ['🏠','🏡','🏢','🛋️','🛏️','🚿','🛁','🪑','🪞','🧲','🔑','🔒','🪴','🏗️','🧱','💡','🏘️','🏬','🪟','🚪','🛗','🚽','🛀','🪥','🪮','🧷','🧹','🧺','🧻','🧽','🧼','🗝️','🔐','🧯','🔌','🔋','🗑️','🖼️','🕯️','🪔'],
  '🏥 Sağlık': ['🏥','💊','🩺','🩹','💉','🦷','👓','🧬','🩻','🩸','💆','🧘','🚑','⚕️','🩼','😷','🤒','🤕','🤢','🤧','🥵','🥶','🧑‍🦽','🧑‍🦼','🧪','🌡️'],
  '📚 Eğitim': ['📚','🎓','✏️','📝','📖','📐','🔬','🔭','🧪','🎒','📓','📌','🏫','🏛️','🖋️','🖊️','🖍️','🖌️','📁','📋','📍','📎','🖇️','📏','🗺️','🌐','🧠','📒','📕','📗','📘','📙','📔','🧮'],
  '🎮 Eğlence': ['🎮','🎬','🎭','🎪','🎡','🎢','🎠','🎤','🎧','🎵','🎶','🎸','🎻','🎺','🥁','🎲','🎯','🎰','📺','📻','📸','📽️','📼','🎷','🎹','🪕','🪘','🎟️','🎫','🎨','🎳','🎱','🧩','♟️','🃏','🎴','🎉','🎊','🎈','🎆','🎇','🔮','🎞️'],
  '⚽ Spor': ['⚽','🏀','🏈','⚾','🎾','🏐','🏓','🏸','🏊','🏋️','🤸','🚴','⛷️','🏄','🧗','🥊','🏆','🥇','🥈','🥉','🏅','🎖️','⛳','🪁','🏹','🎣','🤿','🎿','🛷','🥌','🛹','🛼','🚣','🤽','🧘','🥋','🥅','🎽'],
  '🐾 Evcil Hayvan': ['🐾','🐶','🐱','🐟','🐦','🐰','🐹','🦜','🐢','🦮','🐕','🐩','🐈','🐈‍⬛','🐇','🐁','🐀','🐿️','🦔','🦎','🐍','🐠','🐡','🐬','🦈','🐳','🐋','🐙','🦑','🦞','🦀','🦐','🦁','🐯','🐨','🐼','🐻','🦊','🐷','🐔','🐧','🦆','🦅','🦉','🐝','🦋','🐞','🐌','🐜'],
  '👕 Giyim': ['👕','👔','👗','👠','👟','🧥','👜','👝','🎩','🧢','🕶️','💄','👑','💍','👚','👖','🧣','🧤','🧦','👘','🥻','🩱','🩲','🩳','👛','👡','👢','🥿','🥾','🧳','👓','🥽','🌂','☂️'],
  '🌿 Doğa': ['🌿','🌳','🌸','🌻','🌈','☀️','🌙','☁️','⚡','🔥','💧','❄️','🌊','🍀','🌲','🌴','🌵','🌱','🌾','🍂','🍁','🍃','🍄','🐚','🪨','🪵','🌎','🌍','🌏','🌐','🗺️','🏔️','⛰️','🏕️','🏖️','🏝️','🌋','🗻','🪐','🌟','⭐','✨','☄️'],
  '💻 Teknoloji': ['💻','📱','⌨️','🖱️','🖥️','📷','🎥','📹','🔋','🔌','📡','🛰️','🤖','🧮','⌚','📲','🖨️','💾','💿','📀','🎙️','🎧','📻','📺','🔍','🔎','🔬','⚙️'],
  '🔧 Tamir': ['🔧','🔨','🪚','🪜','🛠️','⚙️','🔩','🪛','🧰','⛏️','🪓','🗜️','🔗','⛓️','🪝','🧲','🧱','🪵','🛡️','🚨','🚧'],
  '📁 Diğer': ['📁','📂','📋','📎','🗂️','🗃️','🗄️','🏷️','✅','❌','⭐','❤️','🔔','🎀','🕐','📅','🗓️','✉️','📮','🎗️','🗳️','💬','💭','🗯️','♠️','♥️','♦️','♣️','🧿','📿','📢','📣','🔕','✔️','➕','➖','✖️','➗','⚠️','♻️','🔱','⚜️','💯','✨','❓','❗','❔','❕','🏁','🚩'],
};
